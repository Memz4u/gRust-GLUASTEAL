-- "gamemodes\\rust\\gamemode\\libs\\bmasks_cl.lua"
...
if BMASKS == nil or true then
	...
	BMASKS.EndMask = function(maskName, x, y, sizex, sizey, opacity, rotation, dontDraw, drawcback)
		...
		if rotation == nil or rotation == 0 then
			...
			surface.SetMaterial(Material("lights/white"))
			if (drawcback) then
				drawcback()
			end
		else
